...
class SinglePhaseEquilibriumLoss(torch.nn.Module):
    def __init__(self,
        ...
        *,
        ...
        # TODO I think this should be moved to optimization, not here
        #if regularize_difference:
        #    self.parameter0 = _snapshot_trainable_parameters(self.all_phases)
        #else:
